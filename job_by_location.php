...
if(isset($_GET['search']))
{
  $search=$_GET['search'];
              ...
              $query="SELECT * FROM job where expire_date >= CURDATE() and location like '%$search%'";
...
<div class="row" style="text-align:center;">
	...
	<form action="job_by_location.php" method="get">
    	<input type="search" class=" in" name="search" placeholder="Enter a location" required="required" style="width: 500px;margin-top: 60px;margin-bottom: 60px;border-radius: 5px;height:50px;border: double 3px lightgreen;text-align: center;">
