...
<div class="row" style="margin-top: 5%;opacity: 0.8">
	<div class="col-sm-6 col-sm-offset-3">
        ...
        <h3>Personal Information</h3>
			...
			<input type="submit" class="btn btn-lg btn-info" role="button" name="Next" value="Next"  id="home_next" style="height:50px;width:100px;position: absolute;top: 330px;right: 20px;" >
		...
		<div id="menu2" style="height:450px;background:rgb(245, 245, 240);color:gray;padding-left:5%;padding-top:3%;z-index: 30;text-align: center;">
			...
			<input type="submit" class="btn btn-lg btn-warning" name="Next" value="Next" id="menu2_next" style="height:50px;width:100px;position: absolute;top: 380px;right: 20px;" >
